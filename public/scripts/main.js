...
styleApp.displayWeatherPieces = function (weather) {
  ...
  var weatherImgEl = $("<img>").attr("src", weatherData.icon_url);
  var cityEl = $("<p>").text(weatherData.observation_location.city);
  var tempEl = $("<p>").text(weatherData.temp_c + " °C");
  var temp = weatherData.temp_c;
  ...
  styleApp.displayClothesByTemp = function (tempResults) {
    ...
    styleData.products.forEach(function (product) {
      ...
      if (filteredCategoryNum > -1 && tempResults > 10) {
        ...
        var topsFilter = ["womens-tops", "polo-tops", "cashmere-tops", "button-front-tops", "shortsleeve-tops", "longsleeve-tops", "sleeveless-tops", "tees-and-tshirts", "tank-tops", "tunic-tops", "tunic-tops", "halter-tops", "cashmere-tops", "tees-and-tshirts", "camisole-tops", "button-front-tops", "longsleeve-tops", "cardigan-sweaters", "sweatshirts", "turleneck-sweaters", "v-neck-sweaters", "cashmere-sweaters", "crewneck-sweaters"];

        var bottomsFilter = ["skinny-jeans", "casual-pants", "stretch-jeans", "leggings", "distressed-jeans", "bootcut-jeans", "cropped-pants", "cropped-jeans", "shorts", "straight-leg-jeans", "relaxed-jeans", "flared-jeans", "classic-jeans", "dress-pants", "mid-length-skirts"];

        var dressesFilter = ["day-dresses", "evening-dresses", "dresses"];

        var coatsFilter = ["coats", "casual-jackets", "denim-jackets", "fur-and-shearling-coats", "leather-andsuede-coats", "raincoats-and-trenchcoats"];
...
styleApp.countProducts = function () {
  ...
  $(".element-item").click(function () {
    ...
    var counter = $("<span>").text(counterNum);
